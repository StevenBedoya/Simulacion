...
Osciladores
Los osciladores son patrones que son predecesores de si mismos. En otras palabras, son patrones que tras un número 
finito de generaciones vuelven a su estado inicial. El número de generaciones determina el período del oscilador. 
Se han descubierto osciladores de todos los períodos, pues hay reglas para generar osciladores de cualquier período deseado.

Los osciladores tienen un rotor y un estátor. El rotor son las células que cambian de estado en algún momento de la 
evolución del oscilador. El estátor son las células que permanecen vivas durante todas las fases de la evolución del 
oscilador. Así por ejemplo, en el caso del blinker, el más simple y frecuente de todos los osciladores, el estátor es 
la célula central, y el rotor son las células izquierda, 
derecha, arriba y abajo de la célula central.

Vidas estáticas
Las vidas estáticas son patrones que no cambian de una generación a la siguiente. Las vidas estáticas se puede considerar 
como osciladores de período 1. En general se asume que las vidas estáticas son finitas y no vacías. Se las puede dividir en 
vidas estáticas estrictas y pseudo vidas estáticas. Las vidas estáticas estrictas son aquellas cuyas partes no son estáticas 
por si mismas.

Naves espaciales
Las naves espaciales son patrones que reaparecen en otra posición tras completar su período. Esto es, son patrones que tras 
un número finito de generaciones vuelven a su estado original pero en una ubicación diferente. La velocidad de una nave es el 
número de celdas que se desplaza dividido por la longitud de su período. El máximo posible es una celda por generación, velocidad 
que se conoce como c (metafóricamente, la velocidad de la luz)

Matusalenes
Los matusalenes son patrones que pueden evolucionar a lo largo de muchos turnos, o generaciones, antes de estabilizarse. El patrón 
Diehard desaparece después de 130 turnos, mientras que Acorn tarda 5206 turnos en estabilizarse en forma de muchos osciladores,
